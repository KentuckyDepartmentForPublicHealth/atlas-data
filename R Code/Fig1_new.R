...
d$Diagnosis<-d$Train.diagnosis_bc
d$tsne1<-d$tsne1_bc
d$tsne2<-d$tsne2_bc
d<-d[d$Diagnosis!="#N/A",]
...
lab[which(lab$Diagnosis=="IDH Mut-1p19q del"),"y"]<-lab[which(lab$Diagnosis=="IDH Mut-1p19q del"),"y"]-8
lab[which(lab$Diagnosis=="IDH Mut-1p19q del"),"x"]<-lab[which(lab$Diagnosis=="IDH Mut-1p19q del"),"x"]-15
...
lab[which(lab$Diagnosis=="Midline"),"y"]<-lab[which(lab$Diagnosis=="Midline"),"y"]-4
lab[which(lab$Diagnosis=="IDH Mutant"),"x"]<-lab[which(lab$Diagnosis=="IDH Mutant"),"x"]+12.75
lab[which(lab$Diagnosis=="IDH Mutant"),"y"]<-lab[which(lab$Diagnosis=="IDH Mutant"),"y"]-4.25
lab[which(lab$Diagnosis=="G34 Mutant"),"x"]<-lab[which(lab$Diagnosis=="G34 Mutant"),"x"]+9
lab[which(lab$Diagnosis=="G34 Mutant"),"y"]<-lab[which(lab$Diagnosis=="G34 Mutant"),"y"]-4.5
...
lab[which(lab$Diagnosis=="Ada. Cranio."),"x"]<-lab[which(lab$Diagnosis=="Ada. Cranio."),"x"]-11
...
lab[which(lab$Diagnosis=="AT/RT-MYC"),"y"]<-lab[which(lab$Diagnosis=="AT/RT-MYC"),"y"]-4
lab[which(lab$Diagnosis=="PXA"),"y"]<-lab[which(lab$Diagnosis=="PXA"),"y"]+3
lab[which(lab$Diagnosis=="Angio."),"x"]<-lab[which(lab$Diagnosis=="Angio."),"x"]-5
lab[which(lab$Diagnosis=="SEGA"),"x"]<-lab[which(lab$Diagnosis=="SEGA"),"x"]-5.5
lab[which(lab$Diagnosis=="DIG"),"x"]<-lab[which(lab$Diagnosis=="DIG"),"x"]+4
lab[which(lab$Diagnosis=="GG"),"x"]<-lab[which(lab$Diagnosis=="GG"),"x"]-1.5
lab[which(lab$Diagnosis=="PA"),"x"]<-lab[which(lab$Diagnosis=="PA"),"x"]-6
lab[which(lab$Diagnosis=="PA"),"y"]<-lab[which(lab$Diagnosis=="PA"),"y"]+6
